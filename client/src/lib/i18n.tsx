...
const dict = {
  ...
  approvalDialogTitle: { en: "Send approval request", cn: "发送审批请求" },
  approvalDialogHint: { en: "Sent to the COO approval mailbox with Fred and Elaine CC'd. The recipient signs in to approve or reject.", cn: "发送至COO审批邮箱，抄送Fred和Elaine。收件人需登录后方可批准或拒绝。" },
  approvalSubject: { en: "Subject", cn: "主题" },
  approvalBody: { en: "Body", cn: "正文" },
  approvalTo: { en: "To (COO approval mailbox)", cn: "收件人（COO审批邮箱）" },
  ...
  approvalSend: { en: "Send approval request", cn: "发送审批请求" },
  approvalSent: { en: "Approval request sent", cn: "审批请求已发送" },
