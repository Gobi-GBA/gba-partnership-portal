...
const dict = {
  ...
  testBannerBody: { en: "For team evaluation only — data may be reset without notice. Please do not share externally.", cn: "仅供团队评估使用 — 数据可能随时重置，恕不另行通知。请勿对外分享。" },
  testBannerDismiss: { en: "Got it", cn: "知道了" },
  testWatermark: { en: "Internal testing only · note from developers Fred & Elaine", cn: "仅供内部测试 · 开发者 Fred 与 Elaine 备注" },
